clear,clc
load Test_data.mat                 % load the new dataset in .mat format and not in cell form
load Setslog2-3-4_data_demo.mat     % load the Setslog file for the concerned objective
Data=Test_data(:,:);
t=1:1:length(Data(:,1));
