...
Setslog = {};
Setslog(1) = {'Setslog2-3-14_shanker.mat'};
Setslog(2) = {'Setslog2-3-13_shanker.mat'};
...
% penalty = 1e1;
% 
% LB_F = [0.4 0 0.9 0.7];              %set upper bound for F1,F2,F3,F4 and so on respectively
% UB_F = [1 10 1 1];                   %set lower bound for F1,F2,F3,F4 and so on respectively
